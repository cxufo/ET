							...
							<div class="tab_panel">
								<form action="">
									<div class="text_input" >
										<span class = "msg_name"><b >新闻标题   :</b> </span><input id="msg_input_01_01" class="msg_input"
											type="text" name="txt_01_01" value="" placeholder="例:中国你好" />
									</div>
									<div class="text_input" >
										<span class = "msg_name"><b >时&nbsp&nbsp&nbsp&nbsp间   :</b> </span>
										<input id="msg_input_01_01" class="msg_input"
											type="text" name="txt_01_01" value="" placeholder="例:2014.09.12" />
									</div>
									<div class="text_input">
									...
									<div class="text_ueditor">
										<span class="msg_name"><b>新闻内容 :</b> </span>
