								...
								<div style="border: 1px solid #E7E7EB;">
									<table id="js_msg_table" class="msg_table"
										...
										<tr style="background-color:#E7E7EB ">
											...
											<th style="width:10%;">职位
											</td>
											<th style="width:;">详情
											</td>
											<th style="width:15%;">有效期
											</td>
										...
										<tr>
											<td>01</td>
											<td>ceo</td>
											<td>阿萨德法国航空玩儿体育i哦破自行车vbnm</td>
											<td>2014.09.25-2014.10.22</td>
											<td><a href="<%=basePath%>./admin/EditRecruitment.jsp" name="editor">编辑</a>/<a
