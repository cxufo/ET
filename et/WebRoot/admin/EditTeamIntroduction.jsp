							...
							<div class="tab_panel">
								...
								<form action="Http://www.baidu.com">
									<div class="text_input">
										<span class="msg_name"><b>职务 :</b> </span><input
											id="msg_input_01_01" class="msg_input" type="tel"
											name="txt_01_01" value="" placeholder="例:总经理!!" />
									</div>
								
									<div class="text_input">
										<span class="msg_name"><b>签名 :</b> </span><input
											id="msg_input_01_01" class="msg_input" type="tel"
											name="txt_01_01" value="" placeholder="例:阿萨德飞规划局快乐自行车" />
									</div>
									<div class="text_input">
									...
									<div class="text_ueditor">
										<span class="msg_name"><b>详细介绍 :</b> </span>
