...
<body style="height: 10000px;">
		...
		<div id="i-div-navigation">
			<%-- 	<ul id = "i-ul-navigation">
				<li style = "background-color: #ED1C24;">
					...
					<a href = "client/index.jsp; javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/home.png"><br>&nbsp;&nbsp;首页</a>
				</li>
				
				<li style = "background-color: #FF7F27;">
					<a href = "client/index.jsp;  javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/introduction.png"><br>&nbsp;&nbsp;简介</a>					
				</li>
				
				<li style = "background-color: #FFCC00;">
					<a href = "client/index.jsp;  javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/service.png"><br>&nbsp;&nbsp;服务</a>
				</li>
				
				<li style = "background-color: #22B14C;">
					<a href = "client/index.jsp;  javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/newspaper.png"><br>新闻动态</a>
				</li>
				
				<li style = "background-color: #00A2E8;">
					<a href = " client/index.jsp; javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/zhaoping.png"><br>招贤纳士</a>
				</li>
				
				<li style = "background-color: #3F48CC;">
					<a href = "client/index.jsp;  javascript:;">&nbsp;&nbsp;<img alt="" src="<%=basePath %>image/icons/contact.png"><br>联系我们</a>
				</li>
			</ul>
						原代码
		 --%>
			<ul id="i-ul-navigation">
				<ul id="i-ul-navigation">
					<li style="background-color: #ED1C24;"><a
						href="<%=basePath%>/index.jsp">&nbsp;&nbsp;<img alt=""
							src="<%=basePath%>image/icons/home.png"><br>&nbsp;&nbsp;首页
					</a></li>
					...
					<li style="background-color: #3F48CC;"><a
						href="Client_ContactUs.jsp">&nbsp;&nbsp;<img alt=""
	...
	<div id="i-div-mainContent">
		...
		<div id="i-div-banner">
			...
			<!-- banner背景 -->
			<div id="i-div-bannerBg">
				<!-- banner背景图 -->
				<ul>
					<li class="active"
						style="background-image: url(<%=basePath%>image/44.jpg);"></li>
